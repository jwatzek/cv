...
% {\large\addfontfeature{Color=lightgray} ~\\ in preparation}

% \hangindent=.7cm \textbf{Watzek J}, Brosnan SF. \emph{in prep.} WhatsOb: An Android app for behavioral observations and live coding of experiments. Poster to be presented at the Annual Meeting of the Society for Computers in Psychology, Boston, MA.
