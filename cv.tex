...
\hangindent=.7cm Suchak M, \textbf{Watzek J}, Quarles LF, de Waal FBM (\emph{submitted}) Expert chimpanzees facilitate success without precise coordination in a cooperative task. \\[.5cm]

% PUBLICATIONS: PEER-REVIEWED: WORKING PAPERS

% \hangindent=.7cm Eppley TM, \textbf{Watzek J}, Hall K, Ganzhorn JU, Donati G \emph{in prep.} Grooming `up' a female-dominated social hierarchy facilitates thermoregulation.

% \hangindent=.7cm \textbf{Watzek J}, Brosnan SF \emph{in prep.} Capuchin monkeys, but neither rhesus macaques nor humans, are `irrational maximizers' in a dynamic stochastic environment
...
~\\[-.75cm]
\hspace{.35cm} {\small\addfontfeature{Color=lightgray} \emph{co-authored presentations not listed}}\\[.5cm] % unless presenting author
...
{\subfont\large\addfontfeature{Color=lightgray} campus presentations}

% PRESENTATIONS: LOCAL: TALKS

\hspace{.35cm} {\addfontfeature{Color=gray} \underline{talks}}
...
\hangindent=.7cm \textbf{Watzek J} (2015) More for me, less for you: Capuchin monkeys' (\emph{Cebus apella}) responses to inequity in a group setting. Cognitive Sciences Seminar, Georgia State University, Atlanta, GA.%\\[.5cm]
...
\hspace{.35cm} {\addfontfeature{Color=gray} \underline{posters} \hspace{.35cm} {\small\addfontfeature{Color=lightgray} \emph{${}^\dagger$undergraduate mentee}}}
