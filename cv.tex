...
\begin{entrylist}
 ...
 \entry
   ...
   % \\{\small\addfontfeature{Color=lightgray} \emph{* Defended; degree to be conferred May 2017}}
  \entry
    {2012}
    {B.\,S.~in Psychology}
...
% \hangindent=.7cm Suchak M, \textbf{Watzek J}, Quarles L, de Waal FBM. (\emph{in prep.}) Expert chimpanzees facilitate success without precise coordination in a cooperative task 
