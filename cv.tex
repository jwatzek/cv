...
\begin{itemize}[align=center]
  \item Pope SM, Fagot J, Meguerditchian A, \textbf{Watzek J}, Lew-Levy S, Autrey MM, Hopkins WD (\emph{revised \& resubmitted}) Optional-switch cognitive flexibility in primates: Chimpanzees' (\emph{Pan troglodytes}) intermediate susceptibility to cognitive set.
  ...
  \item {\textbf{Many Primates ${}^\bullet$} (\emph{submitted}) Establishing an infrastructure for collaboration in primate cognition research.
