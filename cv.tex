...
\begin{itemize}[align=center]
  \item \textbf{Watzek J}, Pope SM, Brosnan SF (\emph{revision invited}) Capuchin and rhesus monkeys but not humans show cognitive flexibility in an optional-switch task.
  \item \textbf{Many Primates\,${}^\bullet$} (\emph{revision invited}) Establishing an infrastructure for collaboration in primate cognition research. [Preprint] doi:10.31234/osf.io/3xu7q
