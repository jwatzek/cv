...
\hangindent=.7cm Smith MF, \textbf{Watzek J}, Brosnan SF (\emph{accepted with minor revisions}) The importance of a truly comparative methodology for comparative psychology. Int J Comp Psychol.\\[.5cm]
...
% \hangindent=.7cm \textbf{Watzek J}, Pope SM, Hopkins WD, Brosnan SF (\emph{in prep.}) Cognitive flexibility in capuchin monkeys, rhesus macaques, and humans in a simplified cognitive set task.
...
\begin{entrylist}
  \entry
    ...
    {Co-chair}
    {}
    {``Hard Data Café'' Cognitive Sciences Seminar $\cdot$ Georgia State University}
  \entry
    {2014--2015}
    {Webmaster}
    {}
