...
\hangindent=.7cm \textbf{Watzek J}, Smith MF, Brosnan SF (\emph{in press}) Comparative economics: Using experimental economics paradigms to understand primate social decision-making. In: d'Almeida AF, di Paolo LD, di Vincenzo F (eds) Evolution of Primate Social Cognition. Springer. doi:10.1007/978-3-319-93776-2 %they'll add "_X" where X is chapter number for the chapter doi
