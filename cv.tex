...
% PUBLICATIONS: BOOK CHAPTERS CONT'D
...
\hangindent=.7cm \textbf{Watzek J}, Brosnan SF (\emph{revised \& resubmitted}) (Ir)rational choices of humans, rhesus macaques, and capuchin monkeys in dynamic stochastic environments.
...
\hangindent=.7cm Aharoni E, Jahedi S, Haskell A, \textbf{Watzek J}, Parker A, Fridlund AJ (\emph{submitted}) Thinking outside the (ballot) box: Effects of cost framing on simulated voting decisions. \\[.5cm]

% \hangindent=.7cm Aharoni E, Kleider-Offutt HM, Brosnan SF, \textbf{Watzek J} (\emph{in prep.}) Justice at any cost? The impact of cost/benefit salience on criminal punishment judgment. \\[.5cm]
