...
% \hspace{.35cm} 
% {\small\color{lightgray} $\color{lightgray} {}^\bullet$ \emph{denotes group authorship}}

\begin{enumerate}[label={[\,\arabic*\,]}]
  \item Aharoni E, Kleider-Offutt HM, Brosnan SF, \textbf{Watzek J} (\emph{in press}) Justice at any cost? The impact of cost/benefit salience on criminal punishment judgment. Behav Sci Law.
  \item \textbf{Watzek J}, Whitham W, Washburn DA, Brosnan SF (\emph{in press}) Responses to modified Monty Hall Dilemmas in capuchin monkeys, rhesus macaques, and humans. Int J Comp Psychol 31.
  ...
  \item \enlargethispage{.5\baselineskip} Eppley TM, \textbf{Watzek J}, Ganzhorn JU, Donati G (2017) Predator avoidance and dietary fibre predict diurnality in the cathemeral folivore \emph{Hapalemur meridionalis}. Behav Ecol Sociobiol 71:4. doi:10.1007/s00265-016-2247-3
\end{enumerate}
...
\begin{enumerate}[resume, label={[\,\arabic*\,]}]
\item Smith MF, \textbf{Watzek J}, Brosnan SF (\emph{in press}) Strategies used by non-human primates in dynamic games. In: Croson R, Capra M, Rigdon MI, Rosenblat T (eds) Handbook of Experimental Game Theory. Edward Elgar Publishing.
...
% % % \hspace{.35cm} {\color{gray} \underline{submitted}}

% \SetLabelAlign{center}{\hss~~#1\hss}
% \begin{itemize}[align=center]
% \item \textbf{Watzek J}, Pope SM, Brosnan SF (\emph{in prep.}) Cognitive flexibility in three primates species in a simple problem-solving task with reduced working memory requirements.
% % \item \textbf{Watzek J}, Smith MF, Brosnan SF (\emph{in prep.}) Strategic decision-making and prediction of opponent behavior in monkeys and humans during a competitive two-player game.
% % \item \textbf{Many Primates ${}^\bullet$} (\emph{in prep.}) Establishing an infrastructure for collaboration in primate cognition research.
...
% % % OLD? \item Aharoni E, Jahedi S, Haskell A, \textbf{Watzek J}, Parker A, Fridlund AJ (\emph{submitted}) Thinking outside the (ballot) box: Effects of cost framing on simulated voting decisions.
