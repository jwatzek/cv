...
\begin{enumerate}[label={[\,\arabic*\,]}]
  ...
  \item {\ul{Many Primates}\,${}^\bullet$ [31 authors] (2019) Establishing an infrastructure for collaboration in primate cognition research. \\\emph{PLOS ONE} 14:e0223675. doi:10.1371/journal.pone.0223675}
  ...
  \item {Pope SM, Fagot J, Meguerditchian A, \textbf{Watzek J}, Lew-Levy S, Autrey MM, Hopkins WD (2019) Optional-switch cognitive flexibility in primates: Chimpanzees' (\emph{Pan troglodytes}) intermediate susceptibility to cognitive set. \\\emph{J Comp Psychol.} Advance Online Publication doi:10.1037/com0000194 }
  ...
  \item {Amici F, Call J, \textbf{Watzek J}, Brosnan SF, Aureli F (2018) Social inhibition and behavioural flexibility when the context changes: a comparison across six primate species. \\\emph{Sci Rep} 8:3067. doi:10.1038/s41598-018-21496-6}  \enlargethispage{1.5\baselineskip}
...
%   \item \textbf{Watzek J}, Hauber ME, Jack KM, Linksvayer TA, Murrell J, Tecot SR, Brosnan SF (\emph{in prep.}) Insights into collective defense behavior from agent-based modeling.
%   % \item \textbf{Watzek J}, Brosnan SF (\emph{in prep.}) Decision-making biases in animals: The fun is in the error bars.
%   \item \ul{Many Primates}\,${}^\bullet$ [XX authors] (\emph{in prep.}) Collaborative open science as a way to reproducibility and new insights in primate cognition research. [Preprint] doi:
