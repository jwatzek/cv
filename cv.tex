...
\begin{entrylist}
  ...
  \entry
    {2020}
    {SIPS Pre-Conference Workshop Travel Award \textnormal{(\emph{declined, COVID-19})}}
    {repliCATS}
    {\\[-.3cm]}
  \entry
    {2019}
...
\begin{itemize}[align=center]
  ...
  \item \textbf{Watzek J}, Brosnan SF (\emph{submitted}) Decision-making biases in animals: A critical review.
