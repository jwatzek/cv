...
{\subfont\large\addfontfeature{Color=lightgray} empirical articles}
...
\hangindent=.7cm \textbf{Watzek J}, Brosnan SF (\emph{in press}) Role-reversal experiment. In: Vonk J, Shackelford T (eds) Encyclopedia of Animal Cognition and Behavior. Springer.
...
\hangindent=.7cm \textbf{Watzek J}, Whitham W, Washburn DA, Brosnan SF (\emph{submitted}) Responses to modified Monty Hall Dilemmas in capuchin monkeys, rhesus macaques, and humans.
...
{\subfont\large\addfontfeature{Color=lightgray} instructor of record}
...
{\subfont\large\addfontfeature{Color=lightgray} teaching assistant}
...
{\subfont\large\addfontfeature{Color=lightgray} guest lecturer}
