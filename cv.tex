...
% \hangindent=.7cm Eppley TM, \textbf{Watzek J}, Ganzhorn JU, Donati G. \emph{revised and resubmitted.} Influences of dietary fibre, predator avoidance, and thermoregulation on cathemeral activity patterns in a small-bodied folivorous primate: \emph{Hapalemur meriodionalis}.

{\large\addfontfeature{Color=lightgray} 2016}

\hangindent=.7cm Eppley TM, \textbf{Watzek J}, Ganzhorn JU, Donati G. \emph{forthcoming.} Predator avoidance and dietary fibre predict diurnality in the cathemeral folivore \emph{Hapalemur meridionalis}. \emph{Behav Ecol Sociobiol} \\[-.1cm] %70(10), xx-xx. doi:10.xx 
...
% \hangindent=.7cm \textbf{Watzek J}, Rossettie MS, Leverett KL, Brosnan SF. \emph{in prep.} Capuchin monkeys' responses to inequity in a group setting. Expected submission Nov 2016.
...
\hangindent=.7cm Fakhri A${}^\dagger$, Le EH${}^\dagger$, \textbf{Watzek J}, Rossettie MS, Leverett KL, Brosnan SF. \emph{forthcoming.} Capuchin monkeys' responses to inequity in a group setting. Poster to be presented at the Psychology Undergraduate Research Conference at Georgia State University, Atlanta, GA.

% \hangindent=.7cm Aharoni E, Jahedi S, Parker AM, Haskell, A. \emph{forthcoming.} Effects of cost framing on simulated voting decisions. Poster to be presented at the Annual Meeting of the Society for Judgment and Decision Making, Boston, MA.
