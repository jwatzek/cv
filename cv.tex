...
% PUBLICATIONS: PREPRINTS & SUBMITTED MANUSCRIPTS
...
\begin{itemize}[align=center]
  ...
  \item \textbf{Watzek J}, Hauber ME, Jack KM, Murrell JR, Tecot SR, Brosnan SF (\emph{submitted}) On the origins of collective decision-making: Insights into collective anti-predator behaviors from agent-based modeling.
...
\begin{enumerate}[label={[\,\arabic*\,]}]
  \item {\textbf{Watzek J}, Brosnan SF (2020) Capuchin and rhesus monkeys show sunk cost effects in a psychomotor task. \\\emph{Sci Rep} 10:20396. \href{https://doi.org/10.1038/s41598-020-77301-w}{\small $\nearrow$}}
  \item {Cooper T\,{\Large${}^\star$}, Zabinski CL\,{\Large${}^\star$}, [\& 10 others] (2020) Long-term memory of a complex foraging task in monitor lizards (Reptilia: Squamata: Varanidae). \\\emph{J Herpetol} 54:378-383. \href{https://doi.org/10.1670/19-122}{\small $\nearrow$} }
...
\includegraphics[width=12cm]{author_contrib.png}\\[.7cm] %width=12cm; width=\linewidth
...
\begin{entrylist}
  ...
  \entry
    ...
    {Field Research Assistant $\cdot$ South Africa}
  \entry
    {2010--2011}
  ...
  \entry
    ...
    {Child \& Adolescent Psychiatry \& Psychotherapy $\cdot$ Intern}
  \entry
    {2009--2010}
...
\begin{entrylist}
  \entry
    {Mar 2021}
    {Georgia State News \href{https://news.gsu.edu/2021/03/04/primate-research-coding-skills-lead-georgia-state-grad-to-work-at-audible/}{\small $\nearrow$}}
    {}
    {``Primate research, coding skills lead Georgia State grad to work at Audible''}
  \entry
    {Jan 2021}
    {Forbes \href{https://www.forbes.com/sites/saratabin/2021/01/31/monkeys-fall-for-the-sunk-cost-fallacy-too-research-suggests/?sh=1ec16f4061c1}{\small $\nearrow$}}
    {}
    {``Monkeys fall for the sunk cost fallacy too, research suggests''}
  \entry
    {Jan 2021}
    {Futurity \href{https://www.futurity.org/monkeys-sunk-costs-2499032/?utm_source=rss&utm_medium=rss&utm_campaign=monkeys-sunk-costs-2499032}{\small $\nearrow$}}
    {}
    {``Monkeys stick with stuff that isn't working, too'}
  \entry
    {Dec 2020}
    {Interesting Engineering \href{https://interestingengineering.com/monkeys-playing-video-games-experience-sunk-costs-just-like-humans}{\small $\nearrow$}}
    {}
    {``Monkeys playing video games experience `sunk costs' just like humans''}
  \entry
    {Dec 2019}
