...
% {\small\addfontfeature{Color=lightgray} $\color{lightgray} {}^\bullet$ \emph{\color{lightgray} denotes group authorship}}
...
% \vspace{-.15cm}\hspace{.35cm} 
% {\small\addfontfeature{Color=lightgray} \emph{\color{lightgray} drafts available}}
