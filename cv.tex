...
\hangindent=.7cm \textbf{Watzek J}, Whitham W, Washburn DA, Brosnan SF (\emph{accepted with minor rev.}) Responses to modified Monty Hall Dilemmas in capuchin monkeys, rhesus macaques, and humans. Int J Comp Psychol.
...
{\subfont\large\addfontfeature{Color=lightgray} review articles}
...
\hangindent=.7cm \textbf{Watzek J}, Smith MF, Brosnan SF (2018) Comparative economics: Using experimental economic paradigms to understand primate social decision-making. In: d'Almeida AF, di Paolo LD, di Vincenzo F (eds) Evolution of Primate Social Cognition. Springer. doi:10.1007/978-3-319-93776-2\_9
...
\begin{entrylist}
  ...
  %   {Visiting Research Scholar (PI: Cristine Legare) $\cdot$ Fieldwork Namibia}
  \entry
    {2012--2014}
