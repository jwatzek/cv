...
\begin{entrylist}
 ...
 \entry
   ...
   {\small\addfontfeature{Color=lightgray} \emph{*Defended; degree to be conferred May 2017}}\\[-.3cm]}
  \entry
    {2012}
    {B.\,S.~in Psychology}
...
\hangindent=.7cm Eppley TM, \textbf{Watzek J}, Ganzhorn JU, Donati G. \emph{in press.} Predator avoidance and dietary fibre predict diurnality in the cathemeral folivore \emph{Hapalemur meridionalis}. \emph{Behav Ecol Sociobiol} \\[-.1cm] %70(10), xx-xx. doi:10.xx 
...
% \hangindent=.7cm Eppley TM, \textbf{Watzek J}, Dausmann KH, Ganzhorn JU, Donati G. \emph{in prep.} Behavioral thermoregulation and the ecological correlates of sleeping site selection by \emph{Hapalemur meridionalis}.
...
% \hangindent=.7cm Talbot CF, Parrish A, \textbf{Watzek J}, Essler J, Leverett KL, Paukner A, Brosnan SF. \emph{in prep.} The influence of reward quality and spatial proximity on the response to inequity and contrast in capuchin monkeys (\emph{Cebus apella})
...
\hangindent=.7cm Fakhri A${}^\dagger$, Le EH${}^\dagger$, \textbf{Watzek J}, Rossettie MS, Leverett KL, Brosnan SF. \emph{forthcoming.} Capuchin monkeys' respond to advantageous inequity. Poster to be presented at the Psychology Undergraduate Research Conference at Georgia State University, Atlanta, GA.
