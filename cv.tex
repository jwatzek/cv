...
\begin{entrylist}
  \entry
    {2014--present}
    {Ph.\,D.~Student Psychology\,/\,Cognitive Sciences}
...
% \hangindent=.7cm Eppley TM, \textbf{Watzek J}, Hall K, Ganzhorn JU, Donati G. \emph{in prep.} Grooming increases access to resting huddle in a female-dominated primate.
