...
\hangindent=.7cm Eppley TM, \textbf{Watzek J}, Dausmann KH, Ganzhorn JU, Donati G (\emph{revised and resubmitted}) Behavioral thermoregulation and the ecological correlates of sleeping site selection by \emph{Hapalemur meridionalis}.\\[-.1cm]

% \hangindent=.7cm Suchak M, \textbf{Watzek J}, Quarles L, de Waal FBM (\emph{submitted}) Expert chimpanzees facilitate success without precise coordination in a cooperative task. \\[-.1cm] 
