...
\includegraphics[width=12.5cm]{author_contrib_noPlos.jpg} %width=\linewidth
...
\begin{itemize}[align=center]
  \item {Many Primates\,${}^\bullet$ [31 authors] (\emph{revised \& resubmitted}) Establishing an infrastructure for collaboration in primate cognition research. \\\emph{PLOS ONE}. Preprint doi:10.31234/osf.io/3xu7q}
  \item Campbell MW\,{\Large${}^\star$}, \textbf{Watzek J\,{\Large${}^\star$}}, Suchak M, Berman SM, de Waal FBM (\emph{submitted}) Chimpanzees tolerate some degree of inequity while cooperating but refuse to donate effort for nothing.
