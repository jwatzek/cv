...
\begin{enumerate}[label={[\,\arabic*\,]}]
  \item {\textbf{Watzek J}, Pope SM, Brosnan SF (\emph{in press}) Capuchin and rhesus monkeys but not humans show cognitive flexibility in an optional-switch task. \\\emph{Sci Rep}}. doi:10.1038/s41598-019-49658-0
...
\includegraphics[width=12.5cm]{author_contrib.jpg} %width=\linewidth
...
\begin{itemize}[align=center]
  \item \textbf{Many Primates\,${}^\bullet$} et al. (\emph{revised \& resubmitted}) Establishing an infrastructure for collaboration in primate cognition research. [Preprint] doi:10.31234/osf.io/3xu7q
  ...
  \item Cooper T\,${}^\bullet$, Zabinski CL\,${}^\bullet$ et al. (\emph{submitted}) Long-term memory of a complex foraging task in squamate reptiles (Reptilia: Squamata: Varanidae).
