...
\hangindent=.7cm Eppley TM, \textbf{Watzek J}, Dausmann KH, Ganzhorn JU, Donati G (\emph{in press}) Behavioral thermoregulation and the ecological correlates of sleeping site selection by \emph{Hapalemur meridionalis}. Anim Behav.
...
\hangindent=.7cm Talbot CF, Parrish A, \textbf{Watzek J}, Essler J, Leverett KL, Paukner A, Brosnan SF (\emph{submitted}) The influence of reward quality and quantity and spatial proximity on the responses to inequity and contrast in capuchin monkeys (\emph{Cebus [Sapajus] apella}) \\[-.1cm]
