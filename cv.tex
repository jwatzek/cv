...
\begin{enumerate}[label={[\,\arabic*\,]}]
  \item {\textbf{Watzek J}, Pope SM, Brosnan SF (\emph{in press}) Capuchin and rhesus monkeys but not humans show cognitive flexibility in an optional-switch task. \\\emph{Sci Rep.}}
...
\begin{itemize}[align=center]
  ...
  % \item Cooper T\,${}^\bullet$, Zabinski CL\,${}^\bullet$, et al. (\emph{in prep.}) Long-term memory of a complex foraging task in squamate reptiles (Reptilia: Squamata: Varanidae).
