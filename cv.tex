...
\begin{enumerate}[label={[\,\arabic*\,]}]
  ...
  \item {Many Primates\,${}^\bullet$ [31 authors] (2019) Establishing an infrastructure for collaboration in primate cognition research. \\\emph{PLOS ONE} 14:e0223675. doi:10.1371/journal.pone.0223675}
...
%   \item \textbf{Watzek J}, Hauber ME, Jack KM, Murrell J, Tecot SR, Brosnan SF (\emph{in prep.}) Insights into collective defense behavior from agent-based modeling.
%   % \item \textbf{Watzek J}, Brosnan SF (\emph{in prep.}) Decision-making biases in animals: The fun is in the error bars.
%   \item Many Primates\,${}^\bullet$ [21? authors] (\emph{in prep.}) Collaborative open science as a way to reproducibility and new insights in primate cognition research. [Preprint] doi:
