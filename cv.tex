...
% {\small\addfontfeature{Color=lightgray} $\color{lightgray} {}^\bullet$ \emph{\color{lightgray} denotes group authorship or equal contribution}}

\begin{enumerate}[label={[\,\arabic*\,]}]
  \item {Pope SM, Fagot J, Meguerditchian A, \textbf{Watzek J}, Lew-Levy S, Autrey MM, Hopkins WD (2019) Optional-switch cognitive flexibility in primates: Chimpanzees' (\emph{Pan troglodytes}) intermediate susceptibility to cognitive set. \\\emph{J Comp Psychol.} doi:10.1037/com0000194 }
  ...
  % \item \enlargethispage{1.5\baselineskip} 
\end{enumerate}
...
\vspace{-.1cm}\hspace{.7cm}
{\small\addfontfeature{Color=lightgray} $\color{lightgray} {}^\bullet$ \emph{\color{lightgray} group authorship\,/\,equal contribution}}


\SetLabelAlign{center}{\hss~~#1\hss}
% \renewcommand\labelitemi{$\Box$}
\begin{itemize}[align=center]
  \item \textbf{Watzek J}, Pope SM, Brosnan SF (\emph{revised \& resubmitted}) Capuchin and rhesus monkeys but not humans show cognitive flexibility in an optional-switch task.
  \item \textbf{Many Primates\,${}^\bullet$} (\emph{revised \& resubmitted}) Establishing an infrastructure for collaboration in primate cognition research. [Preprint] doi:10.31234/osf.io/3xu7q
        % {\quad\small\addfontfeature{Color=lightgray} $\color{lightgray} {}^\bullet$ \emph{\color{lightgray} group authorship}}
  \item Campbell MW\,${}^\bullet$, \textbf{Watzek J\,${}^\bullet$}, Suchak M, Berman SM, de Waal FBM (\emph{submitted}) Chimpanzees tolerate some degree of inequity while cooperating but refuse to donate effort for nothing.
        % {\quad\small\addfontfeature{Color=lightgray} $\color{lightgray} {}^\bullet$ \emph{\color{lightgray} equal contribution}}
  ...
  % \item Cooper T\,${}^\bullet$, Zabinski CL\,${}^\bullet$, et al. (\emph{in prep.}) Long-term memory for a novel foraging cognitive task in monitor and beaded lizard species (Reptilia: Squamata: Varanidae, Helodermatidae) after a two-year hiatus.
  % \item \textbf{Watzek J}, Smith/Webster? MF, Brosnan SF (\emph{in prep.}) Strategic decision-making and prediction of opponent behavior in monkeys and humans during a competitive two-player game.
  ...
  % \item \textbf{Watzek J}, Hauber ME, Jack KM, Murrell J, Tecot SR, Brosnan SF (\emph{in prep.}) Understanding collective defense behavior using agent-based modeling.
  % \item Eppley TM, \textbf{Watzek J}, Donati G (\emph{in prep.}) Hapa goal-directed.
\end{itemize}
...
\begin{entrylist2}
  ...
  \entrytwo
    {2017}
    {``Strategic decision-making in capuchins (\emph{Cebus apella}), rhesus monkeys (\emph{Macaca mulatta}), and humans during a competitive two-player game.'' American Society of Primatologists, Washington, DC. [Published abstract] Am J Primatol 80(S1):39. doi:10.1002/ajp.22942}
  \entrytwo
    {2016}
