...
\hangindent=.7cm \textbf{Watzek J}, Smith MF, Brosnan SF (\emph{in press}) Comparative economics: Using experimental economic paradigms to understand primate social decision-making. In: d'Almeida AF, di Paolo LD, di Vincenzo F (eds) Evolution of Primate Social Cognition. Springer. doi:10.1007/978-3-319-93776-2\_9
...
% % \hangindent=.7cm Campbell MW, \textbf{Watzek J}, Suchak M, Berman SM, de Waal FBM (\emph{submitted}) Chimpanzees tolerate some degree of inequity while cooperating but refuse to donate effort for nothing.

% % OLD? \hangindent=.7cm Aharoni E, Jahedi S, Haskell A, \textbf{Watzek J}, Parker A, Fridlund AJ (\emph{submitted}) Thinking outside the (ballot) box: Effects of cost framing on simulated voting decisions.
% \hangindent=.7cm Aharoni E, Thurman J, Jahedi S, \textbf{Watzek J}, Fridlund AJ (\emph{submitted}) Thinking outside the (ballot) box: Effects of cost framing on simulated voting decisions.
